...
public:
    ...
    /// The visitor may look up or dispatch on this space, and may copy or move
    /// it, but must not add or remove methods or assign to it; a build without
    /// `NDEBUG` asserts when it does.
