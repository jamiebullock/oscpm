...
| [Google Benchmark](https://github.com/google/benchmark) | v1.9.5 (`192ef10025eb2c4cdd392bc502f0c852196baa48`) | Apache-2.0 | Benchmarks only (`OSCPM_BUILD_BENCHMARKS`) | All |
...
The pinned revisions are declared in `tests/CMakeLists.txt`,
`examples/CMakeLists.txt` and `bench/CMakeLists.txt`.
