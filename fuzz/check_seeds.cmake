...
# out by hand from the corpus rather than derived from it.
#
...
# An independent count of the cases: every case line, and only a case
# line, opens with a double quote. A newline is prepended so that every
# line, the first included, is found by the newline before it; MATCHALL
# would let '^' match again at the start of each remainder.
...
# A plain case; an empty Pattern; a space inside a Pattern, which the
# corpus quotes for exactly this reason; a two-byte UTF-8 sequence; a case
# with a '#', which must not be mistaken for a comment; and an unterminated
# '[' in the Pattern.
